  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v9.encoding = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v12.encoding = str[start:end].decode('utf-8', 'rosmsg')
        else:
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v23.encoding = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v26.encoding = str[start:end].decode('utf-8', 'rosmsg')
        else:
