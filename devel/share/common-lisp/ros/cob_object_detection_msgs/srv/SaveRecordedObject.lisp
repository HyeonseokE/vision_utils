...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<SaveRecordedObject-request>)))
  ...
  (cl:format cl:nil "# this service initiates saving the recorded object data~%~%# request message~%string storage_location		# [optional] path to the desired storage folder; if not provided, the standard folder specified in the program will be used~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'SaveRecordedObject-request)))
  "Returns full string definition for message of type 'SaveRecordedObject-request"
  (cl:format cl:nil "# this service initiates saving the recorded object data~%~%# request message~%string storage_location		# [optional] path to the desired storage folder; if not provided, the standard folder specified in the program will be used~%~%~%"))
