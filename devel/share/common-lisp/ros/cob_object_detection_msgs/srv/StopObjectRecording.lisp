...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<StopObjectRecording-request>)))
  ...
  (cl:format cl:nil "# this service stops the object data recording procedure~%~%# request message~%bool stop_although_model_is_incomplete		# if this parameter is False, the recording is not stopped if the recorded data does not cover all desired perspectives~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'StopObjectRecording-request)))
  "Returns full string definition for message of type 'StopObjectRecording-request"
  (cl:format cl:nil "# this service stops the object data recording procedure~%~%# request message~%bool stop_although_model_is_incomplete		# if this parameter is False, the recording is not stopped if the recorded data does not cover all desired perspectives~%~%~%"))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<StopObjectRecording-response>)))
  ...
  (cl:format cl:nil "# response message~%bool recording_stopped				# feedback whether the recording has been stopped in the recording module~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'StopObjectRecording-response)))
  "Returns full string definition for message of type 'StopObjectRecording-response"
  (cl:format cl:nil "# response message~%bool recording_stopped				# feedback whether the recording has been stopped in the recording module~%~%~%~%"))
